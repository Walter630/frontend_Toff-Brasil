...
const legacyProducts: MockProduct[] = [
  ...
  },
  {
    ...
    categoria: 'PECAS',
    estoque: 1,
    variantGroup: 'kit-hotend-a1',
    variantLabel: 'Bico 0.4',
  },
  {
  ...
  },
  {
    ...
    categoria: 'PECAS',
    estoque: 1,
    variantGroup: 'placa-pei-a1',
    variantLabel: 'A1 Mini',
  },
  {
  ...
  },
  {
    ...
    name: 'Placa A1 Mini Holográfica PEO/PET',
    description: 'Placa dupla PET smooth e PEO smooth para Bambu Lab A1 Mini.',
    price: 100,
    image: `${mockImageBase}/placa-smooth-peo-pet.jpg`,
    categoria: 'PECAS',
    estoque: 1,
    variantGroup: 'placa-holografica-a1',
    variantLabel: 'A1 Mini',
  },
  {
    id: 'mock-placa-holografica-peo-pet-a1',
    name: 'Placa A1 Holográfica PEO/PET',
    description: 'Placa A1 holográfica dupla face PEO/PET para Bambu Lab A1.',
    price: 160,
    image: `${mockImageBase}/placa-smooth-peo-pet.jpg`,
    categoria: 'PECAS',
    estoque: 1,
