  ...
  try {
    ...
    if (productIdMatch && request.method === 'PUT') {
      ...
      products[index] = {
        ...
        marca: String(body.marca || '').trim() || undefined,
        type: String(body.type || '').trim() || undefined,
        estoque: Number(body.estoque),
        status: body.status || 'DISPONIVEL',
        codigoBarras: String(body.codigoBarras || '').trim() || undefined,
